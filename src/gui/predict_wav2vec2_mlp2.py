# -*- coding: utf-8 -*-
"""
predict_wav2vec2_mlp2.py

Speech emotion recognition using a fine-tuned Wav2Vec2 backbone
(ehcalabres/xlsr SER) with an external MLP classifier.
...
Created on Sat Jul 26 22:09:00 2025
@author: tunca
"""
...
model_dir = os.path.join(BASE_DIR, "features_and_models/sota_models_pretrained/wav2vec2_model2")
model_name = "ehcalabres/wav2vec2-lg-xlsr-en-speech-emotion-recognition"

# === DEVICE CONFIGURATION ===
device = torch.device("cuda" if torch.cuda.is_available() else "cpu")

# === LOAD FEATURE EXTRACTOR & WAV2VEC2 MODEL ===
...
def predict_emotion(file_path):
    ...
    Wav2Vec2 embeddings + MLP classifier (model v2).

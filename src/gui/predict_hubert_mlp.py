# -*- coding: utf-8 -*-
"""
predict_hubert_mlp.py

Speech emotion recognition using HuBERT embeddings
classified with a PyTorch MLP model.

Used by the GUI layer.


Created on Sat Jul 26 22:13:53 2025
@author: tunca
"""
...
model_dir = os.path.join(BASE_DIR, "features_and_models/sota_models_pretrained/hubert_model")
...
def predict_emotion(file_path):
    ...
    HuBERT embeddings + MLP classifier.

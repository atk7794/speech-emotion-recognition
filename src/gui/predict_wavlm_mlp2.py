# -*- coding: utf-8 -*-
"""
predict_wavlm_mlp2.py

Speech emotion recognition using WavLM-Base-Plus embeddings
classified with a PyTorch MLP model.

Used by the GUI layer.


Created on Sat Jul 26 21:40:08 2025
@author: tunca
"""
...
model_dir = os.path.join(BASE_DIR, "features_and_models/sota_models_pretrained/wavlm_model2")
...
def predict_emotion(file_path):
    ...
    WavLM-Base-Plus embeddings + MLP classifier.

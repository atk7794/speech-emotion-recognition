# -*- coding: utf-8 -*-
"""
predict_wav2vec2_end2end.py

End-to-end speech emotion recognition using a fine-tuned Wav2Vec2 model.
...
Created on Sun Jul 27 00:23:05 2025
@author: tunca
"""
...
# === MODEL DIRECTORY ===
model_dir = os.path.join(BASE_DIR, "features_and_models/sota_models_transformer/wav2vec2_model")
...
def predict_emotion(file_path):
    """
    Predict emotion label from a WAV file using an end-to-end Wav2Vec2 model.
